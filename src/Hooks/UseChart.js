...
import { chartData, chartLostData, chartLostLabels, chartLostValues, getTime, newStock, newStockChart } from '../Helpers/filterData';
import { StopContext } from '../Store/StoreContext'
import UseData from './UseData';

const UseChart = () => {
    //EXTRACCION DEL CONTEXTO
    const {chartMsi = [], chartLocated=[],lostFiltered,lost,stock, isLoading, chartPorcent} = useContext(StopContext);
